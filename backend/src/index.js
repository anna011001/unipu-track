...
import staffMobilitiesRouter from "./routes/international/staffMobilities.js";
...
const allowedOrigins = (
  ...
  "http://localhost:5173,http://localhost:4173,https://unipu-track-y8xt.vercel.app"
)
  .split(",")
...
app.use("/api/memberships", setAuditUser, membershipsRouter);
app.use("/api/professional-developments", setAuditUser, professionalDevelopmentsRouter);
app.use("/api/event-participations", setAuditUser, eventParticipationsRouter);
app.use("/api/workshops", setAuditUser, workshopsRouter);
app.use("/api/coauthorships", setAuditUser, coauthorshipsRouter);
app.use("/api/visiting-researchers", setAuditUser, visitingResearchersRouter);
app.use("/api/stakeholders", setAuditUser, stakeholdersRouter);
app.use("/api/international-conferences", setAuditUser, internationalConferencesRouter);
app.use("/api/staff-mobilities", setAuditUser, staffMobilitiesRouter);
app.use("/api/international-cooperations", setAuditUser, internationalCooperationsRouter);
app.use("/api/schedule-optimizations", setAuditUser, scheduleOptimizationsRouter);
app.use("/api/schedule-adjustments", setAuditUser, scheduleAdjustmentsRouter);
app.use("/api/sabbaticals", setAuditUser, sabbaticalsRouter);
app.use("/api/joint-events", setAuditUser, jointEventsRouter);
app.use("/api/project-applications", setAuditUser, projectApplicationsRouter);
app.use("/api/survey-action-plans", setAuditUser, surveyActionPlansRouter);
